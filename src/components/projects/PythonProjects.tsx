          ...
          {pythonProjects.map((project, index) => (
            ...
            >
              <div className="flex justify-between items-start mb-3 sm:mb-4">
                <h3 className="text-lg sm:text-xl font-semibold text-gray-200 mb-1 sm:mb-2">
                  {project.title}
                </h3>
                <a
                  href={project.github}
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs text-gray-300 bg-cyan-500/20 px-2 sm:px-3 py-1 rounded-full">
                  Python
                </span>
